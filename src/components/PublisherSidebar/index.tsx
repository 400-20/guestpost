...
<FaTasks className="text-xl"/>
        ...
        route: "/publisherGuestPostTasks",
      },
      {
        icon: (
<SiPlatformdotsh className="text-xl"/>
          
        ),
        label: "My Platform",
        route: "/publisherMyPlatform",
      },
    ],
  },
  {
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  useEffect(() => {
    if (pathname === "/publisherDashboard") {
